...
- Analyze using only the provided project, class, syllabus, rubric, and historical data.
- Curriculum alignment must be based on the assigned class syllabus only.
- If syllabus is empty, curriculum_alignment must be 0-30, readinessScore must not exceed 60, and risks must include missing syllabus alignment.
...
- If syllabus exists but there is weak overlap between syllabus content and project content, reduce curriculum_alignment and add a learning risk.
